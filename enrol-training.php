...
<body id="page-top">
	<div id="wrapper">
		<?php include "bars/staff-sidebar.php"; ?><!-- Sidebar -->
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="card mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="">Name</label> <select class="form-control" id="">
                                            <option>training name</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">Date</label> 
                                        <input aria-describedby="" class="form-control" id="" placeholder="Date" type="date" readonly="readonly">
                                    </div>
                                </div><br>
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        ...
                                        <input aria-describedby="" class="form-control" id="" placeholder="Time" type="time" readonly="readonly">
                                    </div>
									<div class="col-md-6">
                                        <label for="">No. of Participants</label> 
                                        <input aria-describedby="" class="form-control" id="" placeholder="Max. Participants" type="text" readonly="readonly">
                                    </div>
                                    
                                </div><br>
                                    <button type="submit" class="btn btn-primary">Enrol Training</button>
                                </div>           
                            </div> 
						</div>
					</div><!--Row-->
