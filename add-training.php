...
if (isset($_POST["add_training"])) {
	...
	$insert_training = "INSERT INTO training (name,training_date,training_time,no_of_participant) VALUE(:name,:training_date,:training_time,:no_of_participant)";
	$insert_train = $pdo->prepare($insert_training);
	$insert_train->bindParam(":name", $name);
	$insert_train->bindParam(":training_date", $date);
	$insert_train->bindParam(":training_time", $time);
	$insert_train->bindParam(":no_of_participant", $participant);
									...
									<div class="row">
										<div class="col-md-6">
											<form method="POST" action=>
												...
												<input aria-describedby="" class="form-control" id="" placeholder="Training Name" name="name" type="text">
										</div>

										<div class="col-md-6">
											<label for="">Date</label>
											<input aria-describedby="" class="form-control" id="" placeholder="Date" name="training_date" type="date">
										</div>
									</div><br>
									<div class="row">
										<div class="col-md-6">
											<label for="">Time</label>
											<input aria-describedby="" class="form-control" id="" placeholder="Time" name="training_time" type="time">
										</div>
										<div class="col-md-6">
											<label for="">No. of Participants</label>
											<input aria-describedby="" class="form-control" id="" placeholder="Max. Participants" name="no_of_participant" type="text">
										</div>
									</div><br>
