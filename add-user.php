...
if (isset($_POST['adduser'])) {
	...
	$insert = "INSERT INTO user(fullname,email,userflow) VALUE(:fullname,:email,:userflow)";
	$insert = $pdo->prepare($insert);
	$insert->bindValue(':fullname', $fullname);
	$insert->bindValue(':email', $email);
	$insert->bindValue(':userflow', $userflow);
	$insert->execute();
}
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<input aria-describedby="" class="form-control" id="" name="fullname" placeholder="Full Name" type="text">
											</div>

											<div class="col-md-6">
												<label for="">Email</label>
												<input aria-describedby="" class="form-control" id="" name="email" placeholder="Email" type="email">
											</div>
										</div><br>
										<div class="row">
											<div class="col-md-6">
