...
<head>
  ...
  <title>189074054 - Enrolled Trainings</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Enrolled Trainings</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Trainings</a></li>
              <li class="breadcrumb-item active" aria-current="page">Enrolled Trainings</li>
            </ol>
          </div>
