							...
							<div class="card mb-4">
                                ...
                                <div class="row">
									<div class="col-md-6">
                                        ...
                                        <input aria-describedby="" class="form-control" id="" placeholder="Training Name" type="text">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="">Date</label> 
                                        <input aria-describedby="" class="form-control" id="" placeholder="Date" type="date">
                                    </div>
                                </div><br>
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        ...
                                        <input aria-describedby="" class="form-control" id="" placeholder="Time" type="time">
                                    </div>
									<div class="col-md-6">
                                        <label for="">No. of Participants</label> 
                                        <input aria-describedby="" class="form-control" id="" placeholder="Max. Participants" type="text">
                                    </div>
