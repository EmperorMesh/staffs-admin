...
if (isset($_GET['edit_venue'])) {
    $venues = $_GET['edit_venue'];
    $getVenueId = "SELECT * FROM venues WHERE venue_id = '{$venues}'";
    $getVenueId = $pdo->prepare($getVenueId);
    $getVenueId->execute();
    while ($row = $getVenueId->fetch()) {
        $name = $row['name'];
...
if (isset($_POST['add_venue'])) {
    ...
    $addVenue = "UPDATE venues SET name=:name, description=:description";
...
<head>
    ...
    <title>189074054 - Add Venue</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Venue</h1>
                        <ol class="breadcrumb">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form method="post" action="">
                                                ...
                                                <input aria-describedby="" class="form-control" id="" placeholder="Name" value="<?php echo $name; ?>" name="name" type="text">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="">Description</label>
                                            <input aria-describedby="" class="form-control" id="" placeholder="Description" value="<?php echo $description; ?>" name="description" type="text">
                                        </div>
                                    </div><br>
