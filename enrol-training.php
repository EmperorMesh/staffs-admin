                                     ...
                                     <div class="card-body">
                                         <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                 ...
                                                 <input aria-describedby="" class="form-control" id="date"
                                                     placeholder="Date" type="text" name='training_date' value=""
                                                     readonly="readonly">
                                             </div>
                                         </div><br>
                                         ...
                                         <div class="row">
                                             <div class="col-md-6">
                                                 ...
                                                 <input aria-describedby="" class="form-control" id="time"
                                                     placeholder="Time" type="text" name='training_time' value=""
                                                     readonly="readonly">
                                             </div>
                                             <div class="col-md-6">
                                                 <label for="">No. of Participants</label>
                                                 <input aria-describedby="" class="form-control" id="nop"
                                                     placeholder="Max. Participants" name='no_of_participant' value=""
                                                     type="text" readonly="readonly">
                                             </div>

                                         </div><br>
                                         <button type="submit" name="enrol" class="btn btn-primary">Enrol
                                             Training</button>
                                     </div>
                                 </div>
                             </form>
